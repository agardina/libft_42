...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/01/28 12:34:41 by agardina          #+#    #+#             */
/*   Updated: 2021/11/21 13:43:06 by agardina         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	get_color(char **str, t_conv *conv)
{
	...
	{"magenta", "\033[35m"}, {"cyan", "\033[36m"}, {"light gray",
		"\033[37m"}, {"dark gray", "\033[90m"}, {"light red", "\033[91m"},
